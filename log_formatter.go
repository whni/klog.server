...
func (f *ColorTextFormatter) init(entry *logrus.Entry) {
...
func (f *ColorTextFormatter) checkIfTerminal(w io.Writer) bool {
	switch v := w.(type) {
	case *os.File:
...
func (f *ColorTextFormatter) SetColorScheme(colorScheme *ColorScheme) {
...
func (f *ColorTextFormatter) printColored(b *bytes.Buffer, entry *logrus.Entry, keys []string, timestampFormat string, colorScheme *compiledColorScheme) {
...
func (f *ColorTextFormatter) needsQuoting(text string) bool {
...
func (f *ColorTextFormatter) appendKeyValue(b *bytes.Buffer, key string, value interface{}, appendSpace bool) {
	b.WriteString(key)
	b.WriteByte('=')
...
func (f *ColorTextFormatter) appendValue(b *bytes.Buffer, value interface{}) {
