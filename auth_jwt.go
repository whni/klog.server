...
type GinJWTMiddleware struct {
	...
	PayloadFunc func(data interface{}) (MapClaims, int)

	// User can define own Unauthorized func.
	Unauthorized func(*gin.Context, int, string)

	// User can define own LoginResponse func.
	LoginResponse func(*gin.Context, int, string, time.Time, int)
...
func JWTNew(m *GinJWTMiddleware) (*GinJWTMiddleware, error) {
...
func (mw *GinJWTMiddleware) MiddlewareInit() error {
	...
	if mw.LoginResponse == nil {
		mw.LoginResponse = func(c *gin.Context, code int, token string, expire time.Time, pid int) {
...
func (mw *GinJWTMiddleware) LoginHandler(c *gin.Context) {
	...
	if mw.PayloadFunc != nil {
		mapclaims, id := mw.PayloadFunc(data)
	...
	mw.LoginResponse(c, http.StatusOK, tokenString, expire, pid)
}
...
func (mw *GinJWTMiddleware) TokenGenerator(data interface{}) (string, time.Time, error) {
	...
	if mw.PayloadFunc != nil {
		mapclaims, _ := mw.PayloadFunc(data)
		for key, value := range mapclaims {
			claims[key] = value
		}
	}
